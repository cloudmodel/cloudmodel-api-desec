ActiveSupport::Reloader.to_prepare do
  require "cloud_model/api/desec"

  CloudModel::AddressResolution.class_eval {
    include CloudModel::Api::Desec::AddressResolution
  }
  ...
  CloudModel.configure do |config|
    ...
    config.api.desec.tokens = {
      'example.com' => 'my-auth-token',
      'example.org' => 'my-other-token'
    }
  end
end